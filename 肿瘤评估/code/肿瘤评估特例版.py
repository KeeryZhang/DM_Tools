        ...
        for i in range(0,len(rowlist)):
            ...
            if idcheck:
                ...
                if InstanceName in Instancelist and cont:
                    ...
                    if 'NE' in IOTATL or 'NA' in IOTATL:
                        if '交叉' in IOTATLT or '第二原发' in IOTATLT:    
                            NAcheck = True                        
                            # for r in rowlist:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cancer", default=r'C:\Users\yao.dong\Desktop\CIBI308C301本地\project4\肿瘤评估\20210728\CIBI308C303_肿瘤评估_20210728.xlsx', help="Please add AE file full path")
